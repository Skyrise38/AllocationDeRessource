...
def select_file():
    PATH = filedialog.askopenfilename(initialdir='/', title='Sélectionner un fichier', filetypes=[('Fichier Excel', '*.xlsx')])
    print('Le fichier sélectionné est:', PATH)  
...
if (PATH!=''):
    ...
    btn_run = tk.Button(window, text='Lancer la fonction', command=Resultats(PATH))
